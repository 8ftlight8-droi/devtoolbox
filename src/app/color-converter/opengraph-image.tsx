...
export const alt = "Color Converter — DevToolBox";
  ...
  return new ImageResponse(
    (
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", width: "100%", height: "100%", backgroundColor: "#030712", padding: "60px" }}>
        <div style={{ fontSize: "72px", fontWeight: 700, color: "#f472b6", marginBottom: "20px" }}>HEX</div>
        <h1 style={{ fontSize: "52px", fontWeight: 700, color: "white", textAlign: "center", marginBottom: "16px" }}>Color Converter</h1>
        <p style={{ fontSize: "24px", color: "#9ca3af", textAlign: "center", maxWidth: "700px" }}>Convert between HEX, RGB, and HSL with live preview. 100% client-side.</p>
