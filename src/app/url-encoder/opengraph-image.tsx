...
export const alt = "URL Encoder/Decoder — DevToolBox";
  ...
  return new ImageResponse(
    (
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", width: "100%", height: "100%", backgroundColor: "#030712", padding: "60px" }}>
        <div style={{ fontSize: "72px", fontWeight: 700, color: "#fb923c", marginBottom: "20px" }}>%</div>
        <h1 style={{ fontSize: "52px", fontWeight: 700, color: "white", textAlign: "center", marginBottom: "16px" }}>URL Encoder / Decoder</h1>
        <p style={{ fontSize: "24px", color: "#9ca3af", textAlign: "center", maxWidth: "700px" }}>Encode and decode URLs with percent-encoding. 100% client-side.</p>
